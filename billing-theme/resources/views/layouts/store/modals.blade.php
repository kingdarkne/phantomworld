                    ...
                    <form action="{{ route('api.store.register') }}" method="POST" data-callback="registerForm">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="first_name" class="form-control" id="registerFirstName" placeholder="First Name" required maxlength="100" autocomplete="given-name">
                            </div>
                            <div class="form-group">
                                <label for="registerLastName">Last Name</label>
                                <input type="text" name="last_name" class="form-control" id="registerLastName" placeholder="Last Name" required maxlength="100" autocomplete="family-name">
                            </div>
                            <div class="form-group">
                                <label for="registerEmailInput">Email Address</label>
                                <input type="email" name="email" class="form-control" id="registerEmailInput" placeholder="Email Address" required autocomplete="email">
                            </div>
                            <div class="form-group">
                                <label for="registerPasswordInput">Password</label>
                                <input type="password" name="password" class="form-control" id="registerPasswordInput" placeholder="Password" required autocomplete="new-password">
                            </div>
                            <div class="form-group">
                                <label for="registerConfirmPasswordInput">Confirm Password</label>
                                <input type="password" name="password_confirmation" class="form-control" id="registerConfirmPasswordInput" placeholder="Confirm Password" required autocomplete="new-password">
                            </div>
                            @include('layouts.store.hcaptcha')
                            <div class="form-group mb-0">
                                <div class="custom-control custom-checkbox">
