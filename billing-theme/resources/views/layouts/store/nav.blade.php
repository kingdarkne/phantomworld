    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse order-3" id="navbarCollapse">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item"><a href="{{ config('app.panel_url') }}" class="nav-link" target="_blank"><i class="fas fa-gamepad mr-1"></i> Game Panel</a></li>
            </ul>
        </div>
        <!-- Right navbar links -->
            ...
            <li class="nav-item dropdown">
                ...
                <ul aria-labelledby="countryMenu" class="dropdown-menu dropdown-menu-right border-0 shadow">
                    @foreach ($tax_model->all() as $tax)
                        <li><a href="{{ route('country', ['id' => $tax->id]) }}" class="dropdown-item">{{ $tax->country === '0' ? 'Global' : $tax->country }}</a></li>
                    @endforeach
                </ul>
            </li>
            <li class="nav-item dropdown">
                <a id="langMenu" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">English</a>
                <ul aria-labelledby="langMenu" class="dropdown-menu dropdown-menu-right border-0 shadow">
