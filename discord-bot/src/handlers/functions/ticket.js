    ...
    client.transcript = async function (interaction, channel) {
        ...
        for (const message of (Array.from(messages.values())).sort((a, b) => a.createdTimestamp - b.createdTimestamp)) {
            ...
            if (message.reference?.messageId) {
                ...
                reference.innerHTML =
                    `<img class="chatlog__reference-avatar" src="${author.displayAvatarURL() ?? static.defaultPFP}" alt="Avatar" loading="lazy">
            ...
            authorAvatar.src = author.displayAvatarURL() ?? static.defaultPFP;
