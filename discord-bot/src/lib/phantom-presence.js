...
function buildLiveActivities(status, client) {
  ...
  activities.push(
    { name: trimActivity('🌆 Phantom World RP — cfx.re/join/3m87mo'), type: ActivityType.Playing },
    ...
    { name: trimActivity('Join Discord · discord.gg/phantomworld'), type: ActivityType.Watching },
...
async function setPhantomBotProfile(client) {
  const description =
    ...
    'Developed by Phantom World · discord.gg/phantomworld';
