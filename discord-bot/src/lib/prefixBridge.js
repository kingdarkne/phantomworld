...
const HARD_ALIASES = {
  ...
  menu: { category: 'help', sub: null, topLevel: true },
  phantomhelp: { category: 'help', sub: null, topLevel: true },
  ask: { category: 'ask', sub: null, topLevel: true },
  say: { category: 'say', sub: null, topLevel: true },
  speak: { category: 'say', sub: null, topLevel: true },
  tts: { category: 'say', sub: null, topLevel: true },
  players: { category: 'players', sub: null, topLevel: true },
  ...
  'status-live': { category: 'statuslive', sub: null, topLevel: true },
