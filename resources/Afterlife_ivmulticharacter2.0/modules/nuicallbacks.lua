...
-- Command to reload character menu if it gets stuck
RegisterCommand('reloadcharacters', function()
    print('[Multicharacter] Reloading character menu...')
    Nuicontrol(false)
    DoScreenFadeOut(500)
    Wait(500)
    Nuimessage('visible', false)
...
-- Command to skip multicharacter and spawn directly (debug only)
RegisterCommand('skipmultichar', function()
    print('[Multicharacter] Skipping to spawn...')
    Nuicontrol(false)
    DoScreenFadeOut(500)
    Wait(500)
    Nuimessage('visible', false)
    DeleteCamScene()
    Wait(1000)
    -- Trigger the spawn event directly
    TriggerEvent('qb-spawn:client:setupSpawnUI', {})
end, false)
