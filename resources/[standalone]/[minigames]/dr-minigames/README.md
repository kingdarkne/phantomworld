...
exports['dr-minigames']:MemoryCard(time)

-- Example
local success = exports['dr-minigames']:MemoryCard(360)
if success then
    --your logic here
end
```
...
exports['dr-minigames']:MineSweep(money, bomb, bombfail, position)

-- EXAMPLE
local success = exports['dr-minigames']:MineSweep(12000, 12, 3, "center")
...
--[[
 ...
 exports['dr-minigames']:OpenTerminal()

 -- EXAMPLE
 local success = exports['dr-minigames']:OpenTerminal()
```
