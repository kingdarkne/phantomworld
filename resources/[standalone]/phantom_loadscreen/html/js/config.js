const Config = {
  brand: 'Phantom World',
  tagline: 'Jump in. Drive. Hustle. Have fun.',
  welcome: 'A freeroam-first Los Santos — jobs on demand, phone contracts, and zero gatekeeping.',
  discord: 'https://discord.gg/Z9Mxu72zZ6',
  discordLabel: 'discord.gg/Z9Mxu72zZ6',
  cfxJoin: 'https://cfx.re/join/3m87mo',
  cfxLabel: 'cfx.re/join/3m87mo',
  host: '172.245.71.46:30120',
  music: {
    enabled: true,
    volume: 0.28,
    src: 'music/background.mp3',
  },
  // Full-bleed city night — warm, friendly atmosphere
  backgroundImage:
