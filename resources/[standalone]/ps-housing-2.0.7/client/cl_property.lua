---@class PropertyData
---@field property_id any
---@field apartment? string
---@field shell string
---@field owner string
---@field has_access table
---@field furnitures table
---@field description string
---@field price number
---@field for_sale boolean
---@field imgs table
---@field door_data table
---@field street string
---@field region string
---@field garage_data table
---@field garden_data table
---@field zone_data any

---@class ShellData
---@field hash number
---@field doorOffset { x: number, y: number, z: number, h: number, width: number }

---@class Property
---@field property_id string|nil
---@field propertyData PropertyData|nil
---@field mloData table|nil
---@field shell any
---@field shellData ShellData|nil
---@field inProperty boolean
---@field shellObj number|nil
---@field has_access boolean
---@field owner boolean
---@field clothingTarget any
---@field storageTarget table
---@field furnitureObjs table
---@field garageZone any
---@field doorbellPool table
---@field entranceTarget any
---@field exitTarget any
---@field blip any
...
function Property:newClient(propertyData)
...
function Property:GetDoorCoords()
    ...
    local propertyData = self.propertyData

    if propertyData and propertyData.apartment and Config.Apartments[propertyData.apartment] then
        coords = Config.Apartments[propertyData.apartment].door
    elseif propertyData then
        coords = propertyData.door_data
    end
...
RegisterNetEvent("ps-housing:client:createOxDoors", function(data)
    local doors, id = data.doors, data.id
