Config = {}
Config.Debug = false
Config.UseOxInv = true -- ox_inventory on QBX
...
local smelterGuy = {
    ...
    tradeLabel = 'Trade 100 Iron for a weapon barrel',
...
local bumGuy = {
    ...
    tradeLabel = 'Trade 100 Plastic for a weapon trigger',
...
local golfGuy = {
    ...
    tradeLabel = 'Trade 100 Cooper for a Weapon grip',
...
local phoneGuy = {
    ...
    tradeLabel = 'Trade 100 glass and 100 still for metal spring',
