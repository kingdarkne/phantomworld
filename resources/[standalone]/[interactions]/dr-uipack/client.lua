-- Notify
RegisterNetEvent('pa-lib:notify')
AddEventHandler('pa-lib:notify', function(text,time, tip)
...
-- UI
RegisterNetEvent('pa-lib:openinfo', function(title, text)
    SendNUIMessage({
        message = 'info',
        toptext = title,
        text = text
...
RegisterNetEvent('pa-lib:closeinfo', function()
    SendNUIMessage({message = 'closeinfo'})
end)

QBCore = nil
QBCore = DrGetQBCore() 

RegisterCommand("ttf",function()
    QBCore.Functions.Notify("Test", "error")
end)

RegisterCommand("notify", function()
    TriggerEvent('pa-lib:notify', 'PA Scripts https://discord.gg/97FHaKvhX4', 5000, 'info')
    TriggerEvent('pa-lib:notify', 'PA Scripts https://discord.gg/97FHaKvhX4', 5000, 'error')
    TriggerEvent('pa-lib:notify', 'PA Scripts https://discord.gg/97FHaKvhX4', 5000, 'success')
end)
...
RegisterCommand("info", function()
    TriggerEvent('pa-lib:openinfo', 'PA Scripts', 'https://discord.gg/97FHaKvhX4')
end)
