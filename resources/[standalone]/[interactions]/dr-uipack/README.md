...
function QBCore.Functions.Progressbar(name, label, duration, useWhileDead, canCancel, disableControls, animation, prop, propTwo, onFinish, onCancel)
    if GetResourceState('dr-uipack') ~= 'started' then error('progressbar needs to be started in order for QBCore.Functions.Progressbar to work') end
    exports['dr-uipack']:Progress({
        name = name:lower(),
        duration = duration,
        label = label,
...
OPEN > TriggerEvent('pa-lib:openinfo', "Get Car" , "Go to motel and take car.")
CLOSE > TriggerEvent('pa-lib:closeinfo')

- SERVER

OPEN > TriggerClientEvent('pa-lib:openinfo', source,"Get Car" , "Go to motel and take car.")
CLOSE > TriggerClientEvent('pa-lib:closeinfo', source)
