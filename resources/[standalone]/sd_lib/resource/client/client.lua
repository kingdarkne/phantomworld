if GetResourceState('qbx_core') == 'started' then Framework = 'qb' elseif GetResourceState('es_extended') == 'started' then Framework = 'esx' end
...
elseif Framework == 'qb' then    
    ...
    -- If neither 'es_extended' nor 'qbx_core' is running, print error
    print("Error: Neither ESX nor Qbox Core resources are running!")
    return
end
