...
local InitFramework = function(framework)
    local objectName if framework == 'es_extended' then objectName = 'es_extended' elseif framework == 'qbx_core' then objectName = 'qbx_core' end
    ...
    if GetResourceState(framework) == 'started' and objectName then
        ...
        elseif objectName == 'qbx_core' then
...
local DetectFramework = function()
    local frameworks = {'es_extended', 'qbx_core'}
