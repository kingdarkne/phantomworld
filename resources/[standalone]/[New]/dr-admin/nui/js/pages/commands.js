...
MC.AdminMenu.LoadItems = function() {
    ...
    // Check if Commands is empty or undefined
    if (!MC.AdminMenu.Commands || Object.keys(MC.AdminMenu.Commands).length === 0) {
        MC.AdminMenu.DebugMessage('^1No commands available');
        $('.admin-menu-items').html('<div class="admin-menu-item"><div class="admin-menu-item-text">No commands available. Check admin permissions.</div></div>');
        return;
    }
