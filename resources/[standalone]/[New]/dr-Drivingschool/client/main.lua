...
function StopDriveTest(success)
	if success then
		lib.callback.await('dr-Drivingschool:server:GetLicense')
...
RegisterNetEvent('drivingtest:start', function()
    ...
    if hasItem then
        ...
        lib.callback.await('dr-Drivingschool:payment')
    end
end)

RegisterNetEvent('dr-Drivingschool:paymentSuccess', function()
    StartTheoryTest()
end)
