...
QBCore.Functions.Notify = QBCore.Functions.Notify or function(msg, nType, duration)
    TriggerEvent('ox_lib:notify', { description = msg, type = nType or 'inform', duration = duration })
end

Config = {}

Config.Framework = 'qbx'        -- qbx / Qbox (use with ox_inventory + ox_target)
Config.Inventory = 'ox'         -- 'ox' for ox_inventory (QBX)
Config.Target = 'ox'            -- 'ox' for ox_target | 'interact' for interact
