 ...
 */ (function (e) {
  ...
  function E(_, P) {
    ...
    try {
      for (
        d(P), v = t(s);
        v !== null && (!(v.expirationTime > P) || (_ && !Pe()));
    ...
    (e.unstable_scheduleCallback = function (_, P, z) {
      ...
      return (
        ...
        z > W
          ...
          : ((_.sortIndex = G), n(s, _), w || g || ((w = !0), hl(E))),
        _
      );
    }),
...
function Ac(e, n, t, r, l, i, o, u, s) {
  (_t = !1), (Rr = null), Uc.apply($c, arguments);
}
function Vc(e, n, t, r, l, i, o, u, s) {
  if ((Ac.apply(this, arguments), _t)) {
    if (_t) {
      var c = Rr;
      (_t = !1), (Rr = null);
...
function qi(e, n, t, r) {
  if (Dr) {
    ...
    else if ((Yo(e, r), n & 4 && -1 < ef.indexOf(e))) {
      for (; l !== null; ) {
        var i = Jt(l);
        if (
          (i !== null && zs(i),
...
function Df(e, n, t) {
  e === "focusin"
    ? (ru(), (xt = n), (Ft = t), xt.attachEvent("onpropertychange", As))
    : e === "focusout" && ru();
}
function If(e) {
  ...
  ws(function () {
    ...
    e: {
      ...
      if (m !== void 0) {
        ...
        for (var a = c, d; a !== null; ) {
          ...
          if (
            (d.tag === 5 &&
              h !== null &&
              ((d = h),
              f !== null && ((h = jt(a, f)), h != null && S.push(At(a, h, d)))),
            F)
          )
            break;
          a = a.return;
        ...
        0 < S.length &&
          ((m = new g(m, w, null, t, p)), v.push({ event: m, listeners: S }));
      }
    }
    if (!(n & 7)) {
      e: {
        ...
        if (
          ...
          if (
            ...
            (F = g == null ? m : $n(g)),
            (d = w == null ? m : $n(w)),
            (m = new S(h, a + "leave", g, t, p)),
            (m.target = F),
            (m.relatedTarget = d),
            (h = null),
            kn(p) === c &&
              ((S = new S(f, a + "enter", w, t, p)),
              (S.target = d),
              (S.relatedTarget = F),
              (h = S)),
            (F = h),
...
function au(e, n, t, r, l) {
  for (var i = n._reactName, o = []; t !== null && t !== r; ) {
    ...
    u.tag === 5 &&
      ...
      ((u = c),
      l
        ? ((s = jt(t, i)), s != null && o.unshift(At(t, s, u)))
        : l || ((s = jt(t, i)), s != null && o.push(At(t, s, u)))),
      (t = t.return);
  }
...
function hn() {
  if (!Il && Ve !== null) {
    ...
    try {
      ...
      throw (Ve !== null && (Ve = Ve.slice(e + 1)), _s(Gi, hn), l);
    } finally {
      (j = n), (Il = !1);
    }
  }
        ...
        e: {
          ...
          switch (((m = n), (g = t), S.tag)) {
            ...
            case 0:
              if (
                ((w = S.payload),
                (m = typeof w == "function" ? w.call(g, v, m) : w),
                m == null)
              )
                break e;
              v = V({}, v, m);
...
function oa(e) {
  ...
  function s(f, a, d, h) {
    var E = d.type;
    return E === Dn
      ? p(f, a, d.props.children, h, d.key)
      : a !== null &&
        (a.elementType === E ||
          (typeof E == "object" &&
            E !== null &&
  ...
  function m(f, a, d, h) {
    ...
    if (typeof d == "object" && d !== null) {
      switch (d.$$typeof) {
        ...
        case Je:
          return (E = d._init), m(f, a, E(d._payload), h);
      }
      if (wt(d) || ct(d)) return E !== null ? null : p(f, a, d, h, null);
      pr(f, d);
    }
    return null;
  }
  function g(f, a, d, h, E) {
    ...
    if (typeof h == "object" && h !== null) {
      ...
      if (wt(h) || ct(h)) return (f = f.get(d) || null), p(a, f, h, E, null);
      pr(a, h);
    }
    return null;
  }
  function w(f, a, d, h) {
    ...
    if (N === d.length) return t(f, x), U && wn(f, N), E;
    if (x === null) {
      for (; N < d.length; N++)
        (x = v(f, d[N], h)),
          x !== null &&
  ...
  function S(f, a, d, h) {
    ...
    if (T.done) return t(f, x), U && wn(f, N), E;
    if (x === null) {
      for (; !T.done; N++, T = d.next())
        (T = v(f, T.value, h)),
          T !== null &&
            ((a = i(T, a, N)), C === null ? (E = T) : (C.sibling = T), (C = T));
      return U && wn(f, N), E;
    }
...
function _a(e, n, t) {
  return zn & 21
    ? (Me(t, n) || ((t = Ns()), (A.lanes |= t), (Ln |= t), (e.baseState = !0)),
      n)
...
function rd(e, n, t) {
  ...
  if (xa(e)) Na(n, l);
    ...
    (t = ta(e, n, l, r)),
      t !== null && ((l = ue()), je(t, e, r, l), Pa(t, n, r));
  }
}
function xa(e) {
  var n = e.alternate;
...
function Lu(e, n, t, r, l) {
  ...
  if ((Zn(n, l), n.stateNode === null))
    Nr(e, n), ia(n, t, r), _i(n, t, r, l), (r = !0);
  else if (e === null) {
    var o = n.stateNode,
      u = n.memoizedProps;
    o.props = u;
    ...
    (o.state = m),
      ...
      u !== r || m !== s || de.current || qe
        ? (typeof p == "function" && (Ei(n, t, p, r), (s = n.memoizedState)),
          (u = qe || wu(n, t, u, r, m, s, c))
            ? (v ||
  ...
  switch ((io(n), n.tag)) {
        ...
        (e === null || e.child === null) &&
          (dr(n)
            ...
            : e === null ||
              ...
              ((n.flags |= 1024), Re !== null && (Fi(Re), (Re = null)))),
        Li(e, n),
        te(n),
        null
      );
    ...
    case 6:
      if (e && n.stateNode != null) Ua(e, n, e.memoizedProps, r);
        ...
        if (((t = _n(Ht.current)), _n($e.current), dr(n))) {
          if (
            ((r = n.stateNode),
            (t = n.memoizedProps),
            (r[Fe] = n),
...
function $a(e) {
  ...
  n !== null && ((e.alternate = null), $a(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Fe], delete n[Vt], delete n[yi], delete n[Zf], delete n[Jf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
  ...
  switch (e.tag) {
    ...
    case 22:
      if (
        ...
        e.mode & 1 ? ((re = (c = re) || p), ze(n, e), (re = c)) : ze(n, e),
        De(e),
        r & 8192)
      ) {
        if (
...
function je(e, n, t, r) {
  ...
  Gt(e, t, r),
    (!(R & 2) || e !== J) &&
      ...
      me(e, r),
      t === 1 && R === 0 && !(n.mode & 1) && ((lt = Q() + 500), ol && hn()));
}
function me(e, n) {
  ...
  if (r === 0)
    ...
    if ((t != null && Ko(t), n === 1))
      e.tag === 0 ? qf(Uu.bind(null, e)) : qs(Uu.bind(null, e)),
        Xf(function () {
          !(R & 6) && hn();
        }),
        (t = null);
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
        ...
        case 3:
          if (
            ...
            e.timeoutHandle = hi(Sn.bind(null, e, ce, Ae), n);
            break;
          }
          Sn(e, ce, Ae);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = hi(Sn.bind(null, e, ce, Ae), r);
            break;
          }
          Sn(e, ce, Ae);
          break;
...
function Tn(e) {
  ...
  try {
    ...
    (j = r), (Ce.transition = t), (R = n), !(R & 6) && hn();
  }
}
function No() {
  (ve = Qn.current), I(Qn);
...
function Sn(e, n, t) {
  var r = j,
    l = Ce.transition;
  try {
    (Ce.transition = null), (j = 1), Sd(e, n, t, r);
  } finally {
    (Ce.transition = l), (j = r);
  }
  return null;
...
function Lr(e, n, t, r, l, i) {
  ...
  if (((r = e), typeof e == "function")) zo(e) && (o = 1);
    ...
    e: switch (e) {
      ...
      case Yl:
        return (
          (e = _e(12, t, n, l | 2)), (e.elementType = Yl), (e.lanes = i), e
        );
      case Xl:
        return (e = _e(13, t, n, l)), (e.elementType = Xl), (e.lanes = i), e;
      case Gl:
        return (e = _e(19, t, n, l)), (e.elementType = Gl), (e.lanes = i), e;
      case os:
        return fl(t, l, i, n);
      default:
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (Zi(n, t | 1), me(n, Q()), !(R & 6) && ((lt = Q() + 500), hn()));
      }
      break;
    case 13:
      Tn(function () {
...
ys = xo;
gs = Tn;
var Td = { usingClientEntryPoint: !1, Events: [Jt, $n, il, vs, hs, xo] },
  yt = {
...
const tc = () => !window.invokeNative,
  jd = () => {},
  rc = (e, n) => {
    const t = oe.useRef(jd);
    oe.useEffect(() => {
      t.current = n;
    }, [n]),
      oe.useEffect(() => {
        const r = (l) => {
          const { action: i, data: o } = l.data;
          t.current && i === e && t.current(o);
        };
        return (
...
const Dd = oe.createContext(null),
  Id = ({ children: e }) => {
    const [n, t] = oe.useState(!1);
    return (
      rc("setVisible", t),
      oe.useEffect(() => {
        if (!n) return;
        const r = (l) => {
          ["Backspace", "Escape"].includes(l.code) &&
            (tc() ? t(!n) : Md("hideFrame"));
        };
        return (
      ...
      O.jsx(Dd.Provider, {
        value: { visible: n, setVisible: t },
        children: O.jsx("div", {
          style: { visibility: n ? "visible" : "hidden", height: "100%" },
          children: e,
        }),
      })
    );
  ...
  Fd = () => {
    const [e, n] = oe.useState([]),
      [t, r] = oe.useState([]),
      [l, i] = oe.useState("online"),
      [o, u] = oe.useState(0),
      [s, c] = oe.useState(0);
    return (
      rc("setVisible", (p) => {
        console.log("setVisible", p);
      }),
      oe.useEffect(() => {
        window.addEventListener("message", (p) => {
          p.data.action === "SetPlayerList"
            ? (n(p.data.data.activePlayers),
              r(p.data.data.disconnectedPlayers),
              u(p.data.data.activePlayers.length),
              c(p.data.data.disconnectedPlayers.length))
            : p.data.action === "getData" &&
              (p.data.data.variable === "online"
                ? (n(p.data.data.players), u(p.data.data.players.length))
                : p.data.data.variable === "disconnected" &&
                  (r(p.data.data.players), c(p.data.data.players.length)));
        });
      }, []),
      O.jsx("div", {
        className: "App",
        children: O.jsxs("div", {
          className: "playerList1",
          children: [
            O.jsxs("div", {
              className: "HeaderPlayerlist",
              children: [
                O.jsxs("div", {
                  className: "flex flex-col justify-start items-start",
                  children: [
                    O.jsx("div", {
                      className: "_title_uaumd_9",
                      children: "PLAYER LIST",
                    }),
                    // O.jsx("div", {
                    //   className: "_description_uaumd_18",
                    //   children: "HERE YOU CAN SEE ALL PLAYERS",
                    // }),
                  ],
                }),
                O.jsxs("div", {
                  className: "_playerCount_uaumd_54",
                  children: [
                    "TOTAL PLAYERS",
                    O.jsx("div", { className: "ScopeNumber", children: o }),
                  ],
                }),
                O.jsxs("div", {
                  className: "_playerCount_uaumd_54 _purple_uaumd_88",
                  children: [
                    "TOTAL IN SCOPE",
                    O.jsx("div", { className: "ScopeNumber", children: s }),
                  ],
                }),
                O.jsxs("div", {
                  className: "KeyBindXD",
                  children: [
                    O.jsx("div", { className: "TextBind", children: "Exit" }),
                    O.jsx("div", { className: "ButtonBind", children: "ESC" }),
                  ],
                }),
              ],
            }),
            O.jsxs("div", {
              className: "_nav_10n6p_1",
              children: [
                O.jsx("div", {
                  className: `_button_10n6p_9 _green_10n6p_20 ${
                    l === "online" ? "_active_10n6p_29" : ""
                  }`,
                  onClick: () => i("online"),
                  children: "Online Player List",
                }),
                O.jsx("div", {
                  className: `_button_10n6p_9 _red_10n6p_33 ${
                    l === "disconnected" ? "_active_10n6p_29" : ""
                  }`,
                  onClick: () => i("disconnected"),
                  children: "Disconnected Player List",
                }),
              ],
            }),
            O.jsx("div", {
              className: "list_tnsyh_24",
              children: (l === "online" ? e : t).map((p, v) =>
                O.jsxs(
                  "div",
                  {
                    className:
                      "w-full flex flex-row items-center justify-between gap-[1vh]",
                    children: [
                      O.jsx("div", {
                        className: "playerBox_tnsyh_35",
                        children: O.jsx("svg", {
                          width: "1.66vh",
                          height: "2.03vh",
                          viewBox: "0 0 18 22",
...
Ql.createRoot(document.getElementById("root")).render(
  O.jsx(kc.StrictMode, { children: O.jsx(Id, { children: O.jsx(Fd, {}) }) })
);
