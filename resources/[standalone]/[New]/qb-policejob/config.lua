...
Config.Locations = {
    ["duty"] = {
        [1] = vector3(611.0010, 7.4967, 82.7600), -- LSPD
    ...
    ["stash"] = {
        [1] = vector3(561.5146, 3.1900, 69.3573), -- LSPD
    ...
    ["helicopter"] = {
        [1] = vector4(610.3484, -24.4488, 91.7074, 152.3834), -- LSPD
        [2] = vector4(-462.15, 5994.77, 31.25, 134.84), -- BCSO
    },
    ["helispawn"] = { -- The numbers [1] must match the numbers in [helicopter]
        [1] = vector4(602.3983, -28.6456, 91.7074, 252.9641), -- LSPD
        [2] = vector4(-475.18, 5988.43, 31.72, 317.27), -- BCSO
    },
    ["armory"] = {
        [1] = vector3(604.1343, 18.2541, 82.7601), -- LSPD
        [2] = vector3(-444.12, 6013.53, 37.00), -- BCSO
        [3] = vector3(1836.2, 3687.01, 34.19), -- Sandy
    },
    ["trash"] = {
        [1] = vector3(537.5463, 26.4458, 69.5109), -- LSPD
    },
    ["fingerprint"] = {
        [1] = vector3(564.7575, 11.5300, 69.3572), -- LSPD
        [2] = vector3(-452.22, 5997.96, 27.58), --BCSO
    },
    ["evidence"] = {
        [1] = vector3(612.1320, -0.4041, 87.0515), -- LSPD
        [2] = vector3(-452.87, 5999.38, 37.00), -- BCSO
        [3] = vector3(1817.97, 3672.25, 34.2), -- Sandy
    },
    ["labs"] = {
        [1] = vector3(625.6982, -2.1141, 87.0514), -- LSPD
    },
    ["stations"] = {
        [1] = {label = "Vinewood Police Department", coords = vector4(602.3983, -28.6456, 91.7074, 252.9641), sprite= 137, scale= 0.7, colour= 29},
    },
}
