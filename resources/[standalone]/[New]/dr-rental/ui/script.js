...
closeNUI = () => {
  $.post(`https://dr-rental/close`, JSON.stringify({}));
...
$(document).on('click', '.pay-button', function (e) {
  ...
  $.post(`https://dr-rental/rent`, JSON.stringify({
    carName: carName,
    carPrice: newPrice,
...
$(document).on('click', '.category-box .item', function (e) {
  ...
  $('.category-box .item').children('i').css('color','#f8f8f8d2')
  $('.category-box .item').children('.name').css('color','#f8f8f8d2')

  $(this).css('background-color','rgba(255, 209, 82, 0.411)')
  // $(this).css('border','1px solid #ffe263')
  $(this).children('i').css('color','#ffe263')
  $(this).children('.name').css('color','#ffe263')
...
$(document).on('click', '.car-box .car-item', function (e) {
  ...
  $('.car-box .car-item').children('i').css('color','#ffe263')
  $('.car-box .car-item').children('.name').css('color','#ffe263')
