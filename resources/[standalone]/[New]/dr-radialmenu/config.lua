...
RegisterNetEvent("QBCore:Client:OnJobUpdate") -- dont edit this unless you don't use qbx_core
...
RegisterNetEvent('QBCore:Client:SetDuty') -- dont edit this unless you don't use qbx_core
