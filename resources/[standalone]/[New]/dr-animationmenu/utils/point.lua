...
RegisterCommand('point', function()
	...
	if not IsPedInAnyVehicle(ped, false) then
		...
		while mp_pointing do
			...
			local ray = StartShapeTestCapsule(coords.x, coords.y, coords.z - 0.2, coords.x, coords.y, coords.z + 0.2, 0.4,
				95, ped, 7)
...
RegisterKeyMapping('point', 'Toggles Point', 'keyboard', AK4Y.PointKey)
