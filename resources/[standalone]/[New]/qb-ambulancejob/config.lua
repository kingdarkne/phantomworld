...
Config.BillCost = 10000 -- Price that players are charged for using the hospital check-in system
Config.DeathTime = 30 -- How long the timer is for players to bleed out and respawn at hospital (seconds; 30 = 0.5 min)
Config.ReviveInterval = 60 -- How long the timer is for players to revive a player in laststand (seconds; 60 = 1 min)
Config.MinimumRevive = 60 -- How long the timer is for players to revive a player in laststand (seconds; 60 = 1 min)
...
Config.Locations = { -- Edit the various interaction points for players or create new ones
    ["checking"] = {
	    [1] = vector3(-489.4881, -987.0329, 24.2894),
	    [2] = vector3(-254.54, 6331.78, 32.43), -- paleto
    },
    ["duty"] = {
        [1] = vector3(-487.4866, -990.1233, 24.2893),
        [2] = vector3(-254.88, 6324.5, 32.58),
    },
    ["vehicle"] = {
        [1] = vector4(-469.3595, -988.9996, 24.2888, 182.5487),
        [2] = vector4(-234.28, 6329.16, 32.15, 222.5),
    },
    ["helicopter"] = {
        [1] = vector4(-454.0222, -1029.7739, 38.3968, 172.7798),
        [2] = vector4(-475.43, 5988.353, 31.716, 31.34),
    },
    ["armory"] = {
        [1] = vector3(-470.1181, -1042.8885, 24.2892),
    ...
    ["beds"] = {
        [1] = {coords = vector4(-458.5793, -1029.9644, 34.6046, 358.1092), taken = false, model = 2117668672},
        [2] = {coords = vector4(-454.8336, -1029.9615, 34.6047, 358.2370), taken = false, model = 2117668672},
        [3] = {coords = vector4(-450.9519, -1030.0555, 34.6047, 1.7721), taken = false, model = 2117668672},
        [4] = {coords = vector4(-447.1002, -1030.0457, 34.6047, 356.8789), taken = false, model = 2117668672},
        [5] = {coords = vector4(-447.5138, -1024.3939, 34.6047, 175.6389), taken = false, model = 2117668672},
        [6] = {coords = vector4(-451.2901, -1024.2219, 34.6047, 179.2883), taken = false, model = 2117668672},
        [7] = {coords = vector4(-455.0266, -1024.2018, 34.6047, 188.0281), taken = false, model = 2117668672},
        [8] = {coords = vector4(-458.8987, -1024.2522, 34.6047, 177.5573), taken = false, model = 2117668672},
    ...
    ["stations"] = {
        [1] = {label = Lang:t('info.pb_hospital'), coords = vector4(-458.8987, -1024.2522, 34.6047, 177.5573)}
    }
}
...
Config.AuthorizedVehicles = { -- Vehicles players can use based on their ambulance job grade level
	-- Grade 0
	[0] = {
        ["ambulance1"] = "Ambulance 1",
        ["royalg30medic"] = "Royal G30",
