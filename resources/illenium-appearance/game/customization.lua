...
function client.startPlayerCustomization(cb, conf)
    -- Fade must clear before opening NUI. Do NOT wait on IsPlayerTeleportActive / IsPlayerSwitchInProgress —
    -- they can stay true for the whole session on some builds and block the outfit menu forever.
