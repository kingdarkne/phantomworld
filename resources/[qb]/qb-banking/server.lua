...
-- Commands (givexp-style: deferred reg + permission in handler + fallback)
local function registerGiveCashCommand()
    ...
    RegisterCommand('givecash', handler, false)
end
CreateThread(function() Wait(500) registerGiveCashCommand() end)
