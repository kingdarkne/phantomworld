...
--- @return string|integer closestPlayer - The Player that is closest to the source player (or the provided coordinates). Returns -1 if no Players are found.
...
function QBCore.Functions.GetDatabaseInfo()
    ...
    elseif connectionString:find("mysql://") then
        ...
        local connectionParts = { string.strsplit(";", connectionString) }

        for i = 1, #connectionParts do
            local v = connectionParts[i]
