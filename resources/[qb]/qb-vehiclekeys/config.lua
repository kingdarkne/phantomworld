...
-- Hotwire Settings (make hotwiring very easy)
Config.HotwireChance = 1.0 -- Always succeed when hotwiring
Config.TimeBetweenHotwires = 2000 -- 2 seconds between attempts
Config.minHotwireTime = 3000 -- 3 seconds minimum hotwire time
Config.maxHotwireTime = 5000 -- 5 seconds maximum hotwire time
