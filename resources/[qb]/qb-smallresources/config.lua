...
-- Nag while driving without seatbelt (client-side; set enabled = false to turn off)
Config.SeatbeltReminder = {
    enabled = true,
    intervalMs = 900, -- lower = more spam
    message = 'PUT YOUR SEATBELT ON NOW!!!!!!!!!!!!!!!',
}
