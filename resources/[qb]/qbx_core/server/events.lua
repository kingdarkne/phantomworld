...
AddEventHandler('onResourceStart', function(resource)
    ...
    -- Older MySQL versions don't support "ADD COLUMN IF NOT EXISTS" syntax.
    -- qbx_core will operate fine without this automatic migration as long as
    -- the `userId` column is present when you actually need multi-account linking.
    -- If you want it, run the ALTER manually once in your DB admin:
