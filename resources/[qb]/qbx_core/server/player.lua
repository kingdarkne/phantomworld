...
function CheckPlayerData(source, playerData)
    ...
    -- `charinfo.cid` can sometimes be an empty string when importing characters.
    -- MySQL expects an integer for `players.cid`, so sanitize here.
    playerData.cid = tonumber(playerData.charinfo?.cid) or tonumber(playerData.cid) or 1
    ...
    playerData.charinfo.cid = tonumber(playerData.charinfo.cid) or playerData.cid
    -- Metadata
