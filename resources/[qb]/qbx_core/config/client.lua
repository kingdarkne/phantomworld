return {
    -- Phantom World: hunger/thirst still decay and food/drink still work, but empty needs cannot kill.
    disableNeedDamage = true,
    ...
    characters = {
        -- When true: Qbox multichar UI in qbx_core is off; use `renzu_multicharacter` + `renzu_spawn` instead.
        useExternalCharacters = true,
        enableDeleteButton = true, -- Only used by built-in Qbox multichar (useExternalCharacters false).
        startingApartment = true, -- Only used by built-in Qbox multichar (useExternalCharacters false).
