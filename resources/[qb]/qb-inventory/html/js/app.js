...
$(document).on("mouseenter", ".item-slot", function (e) {
    ...
    if ($("#qbcore-inventory").css("display") == "block") {
        ...
        } else if (itemData && itemData.name == "housekey") {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html(
                "<p><strong>House: </strong><span>" +
                itemData.info.HouseName +
                "</span></p><p><strong>Address: </strong><span>" +
                itemData.info.Address + "</span></p>"
            );
        } else if (itemData && itemData.name == "harness") {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html(
                "<p>" + itemData.info.uses + " uses left.</p>"
            );
        } else if (itemData && itemData.name == "mechboard") {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html(
        ...
        } else if (itemData && itemData.name == "filled_evidence_bag") {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
