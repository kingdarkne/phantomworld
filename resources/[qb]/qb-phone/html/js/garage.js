        ...
        $.each(Vehicles, function(i, vehicle){
            ...
            '<div class="garage-block">' +
                ...
                '<div class="garage-box" id="' + vehicle.plate + '">' +
                    '<span class="valet-vehicle" id="valet-vehicle" style="margin-right: 1.5vh;">VALET</span>' +
                    '<span class="garage-box box-track" style="margin-left: 2.5vh;">TRACK</span>' +
                    '<span class="garage-box box-sellvehicle" style="margin-left: 0.6vh;">SELL</span>' +
                '</div>' +
            '</div>'            
            '</div>' +
            '</div>';
...
$(document).on('click', '#valet-vehicle', function(e){
    ...
    // var plate = document.getElementsByClassName("garage-plate");
    // var garage = document.getElementsByClassName("garage-name");
    // console.log(plate, garage);
    var plate = $(".valet-vehicle").data();
    console.log(plate)
