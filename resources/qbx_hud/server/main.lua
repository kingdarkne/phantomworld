...
--- Server time + display name for qbx_hud top strip (sv_projectName / sv_hostname)
...
RegisterNetEvent('qbx_hud:requestServerInfo', function()
    local src = source
    TriggerClientEvent('qbx_hud:client:serverInfo', src, {
