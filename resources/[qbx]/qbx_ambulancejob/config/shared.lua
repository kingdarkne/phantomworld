return {
    ...
    locations = { -- Various interaction points
        duty = {
            vec3(311.18, -599.25, 43.29),     -- Pillbox
            vec3(-254.88, 6324.5, 32.58),     -- Paleto
            vec3(1836.3, 3679.4, 34.28),      -- Sandy Shores (Medical Center)
        },
        vehicle = {
            vec4(294.578, -574.761, 43.179, 35.79),  -- Pillbox
            vec4(-234.28, 6329.16, 32.15, 222.5),   -- Paleto
            vec4(1842.1, 3681.2, 34.28, 120.0),     -- Sandy Shores
        },
        helicopter = {
            vec4(351.58, -587.45, 74.16, 160.5),     -- Pillbox
            vec4(-475.43, 5988.353, 31.716, 31.34), -- Paleto
        },
        armory = {
            {
        ...
        hospitals = {
            ...
            sandy = {
                coords = vec3(1839, 3673, 34),
                checkIn = vec3(1833.5, 3674.3, 34.28),
                beds = {
                    {coords = vec4(1837.2, 3671.5, 34.28, 120.0), model = 2117668672},
                    {coords = vec4(1834.8, 3676.2, 34.28, 120.0), model = 2117668672},
                    {coords = vec4(1830.9, 3681.5, 34.28, 120.0), model = 2117668672},
                },
            },
            jail = {
        ...
        stations = {
            ...
            {label = 'Paleto Hospital', coords = vec4(-252.5, 6325.5, 32.43, 227.5)},
            {label = 'Sandy Shores Medical', coords = vec4(1836.3, 3679.4, 34.28, 120.0)},
        }
    },
}