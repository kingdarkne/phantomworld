...
Config.vehiclesByRegion = {
    losSantos = {
        ...
        { model = 'lspd1',   peds = {'s_m_y_cop_01', 's_f_y_cop_01'}, wantedLevel = 1, spawnChance = 3, numPeds = 2, loadout = 'patrol' },
        { model = 'lspd9',   peds = {'s_m_y_cop_01', 's_f_y_cop_01'}, wantedLevel = 1, spawnChance = 3, numPeds = 2, loadout = 'patrol' },
        { model = 'lspd14',  peds = {'s_m_y_cop_01', 's_f_y_cop_01'}, wantedLevel = 1, spawnChance = 2, numPeds = 2, loadout = 'patrol' },
        { model = 'lspd22',  peds = {'s_m_y_cop_01', 's_f_y_cop_01'}, wantedLevel = 1, spawnChance = 2, numPeds = 2, loadout = 'patrol' },
        { model = 'police3',   peds = {'s_m_y_cop_01', 's_f_y_cop_01'}, wantedLevel = 1, spawnChance = 1, numPeds = 2, loadout = 'patrol' },
        { model = 'lspd4',   peds = {'s_m_y_cop_01', 's_f_y_cop_01'}, wantedLevel = 2, spawnChance = 2, numPeds = 2, loadout = 'patrol' },
        { model = 'lspd8',   peds = {'s_m_y_cop_01', 's_f_y_cop_01'}, wantedLevel = 2, spawnChance = 2, numPeds = 2, loadout = 'patrol' },
        ...
        { model = 'lspd18',  peds = {'S_M_M_CIASec_01'},              wantedLevel = 2, spawnChance = 2, numPeds = 2, loadout = 'undercover' },
    ...
    paletoBay = {
        ...
        { model = 'lspd2',  peds = {'s_m_y_sheriff_01', 's_f_y_sheriff_01'}, wantedLevel = 1, spawnChance = 3, numPeds = 2, loadout = 'sheriff' },
        { model = 'lspd5',  peds = {'s_m_y_sheriff_01', 's_f_y_sheriff_01'}, wantedLevel = 1, spawnChance = 3, numPeds = 2, loadout = 'sheriff' },
        ...
        { model = 'lspd14', peds = {'s_m_y_sheriff_01', 's_f_y_sheriff_01'}, wantedLevel = 2, spawnChance = 2, numPeds = 2, loadout = 'sheriff' },
        { model = 'riot',     peds = {'S_M_Y_Swat_01'},                        wantedLevel = 3, spawnChance = 10, numPeds = 4, loadout = 'riot' },
        { model = 'fbi',      peds = {'S_M_M_FIBSec_01'},                       wantedLevel = 5, spawnChance = 15, numPeds = 2, loadout = 'fbi' },
        { model = 'fbi2',     peds = {'S_M_M_FIBSec_01'},                       wantedLevel = 5, spawnChance = 15, numPeds = 4, loadout = 'fbi' },
    },
    sandyShores = {
        { model = 'policeb',  peds = {'S_M_Y_HwayCop_01'},                     wantedLevel = 1, spawnChance = 1, numPeds = 1, loadout = 'bike' },
        { model = 'sheriff',  peds = {'s_m_y_sheriff_01', 's_f_y_sheriff_01'}, wantedLevel = 1, spawnChance = 3, numPeds = 2, loadout = 'sheriff' },
        { model = 'lspd4',  peds = {'s_m_y_sheriff_01', 's_f_y_sheriff_01'}, wantedLevel = 1, spawnChance = 3, numPeds = 2, loadout = 'sheriff' },
        { model = 'lspd22', peds = {'s_m_y_sheriff_01', 's_f_y_sheriff_01'}, wantedLevel = 1, spawnChance = 3, numPeds = 2, loadout = 'sheriff' },
        { model = 'sheriff2', peds = {'s_m_y_sheriff_01', 's_f_y_sheriff_01'}, wantedLevel = 1, spawnChance = 3, numPeds = 2, loadout = 'sheriff' },
        { model = 'police3',  peds = {'S_M_M_CIASec_01'},                      wantedLevel = 2, spawnChance = 2, numPeds = 2, loadout = 'undercover' },
        { model = 'lspd9',  peds = {'s_m_y_sheriff_01', 's_f_y_sheriff_01'}, wantedLevel = 2, spawnChance = 2, numPeds = 2, loadout = 'sheriff' },
        { model = 'riot',     peds = {'S_M_Y_Swat_01'},                       wantedLevel = 3, spawnChance = 10, numPeds = 4, loadout = 'riot' },
        { model = 'fbi',      peds = {'S_M_M_FIBSec_01'},                      wantedLevel = 5, spawnChance = 15, numPeds = 2, loadout = 'fbi' },
        { model = 'fbi2',     peds = {'S_M_M_FIBSec_01'},                      wantedLevel = 5, spawnChance = 15, numPeds = 4, loadout = 'fbi' },
    },
    countryside = {
        ...
        { model = 'lspd4', peds = {'s_m_y_sheriff_01', 's_f_y_sheriff_01'}, wantedLevel = 1, spawnChance = 3, numPeds = 2, loadout = 'sheriff' },
        { model = 'lspd7', peds = {'s_m_y_sheriff_01', 's_f_y_sheriff_01'}, wantedLevel = 1, spawnChance = 3, numPeds = 2, loadout = 'sheriff' },
        { model = 'lspd16', peds = {'s_m_y_ranger_01', 's_f_y_ranger_01'}, wantedLevel = 1, spawnChance = 5, numPeds = 2, loadout = 'ranger' },
        ...
        { model = 'police4', peds = {'S_M_M_CIASec_01'}, wantedLevel = 2, spawnChance = 2, numPeds = 2, loadout = 'undercover' },
        { model = 'lspd8', peds = {'S_M_M_CIASec_01'}, wantedLevel = 2, spawnChance = 3, numPeds = 2, loadout = 'undercover' },
