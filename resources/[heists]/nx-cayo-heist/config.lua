...
-- hack anim props (ped component variation for bag)
Config.HideBagID = 0   -- component variation to hide/remove bag
Config.BagUseID = 0    -- component variation when using bag
