return {
    ...
    vehicles = {
        ---@type VehicleConfig
        default = {
            noLock = false, -- Locking system enabled (for fair hijacking)
            spawnLockedIfParked = 0.0, -- Spawn unlocked when parked (players can exit)
            spawnLockedIfDriven = 0.0, -- Spawn unlocked when driven (players can exit)
        ...
        models = {
            --- Police Mustang (`2015polstang`): only the DB owner may get keys; no hotwire/loot keys for others.
            [`2015polstang`] = {
                lockpickImmune = true,
