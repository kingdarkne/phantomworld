...
Config.CoreName = 'qbx_core' -- legacy field; script uses ox/qb-target — no qb-core resource required on Qbox
...
AlertCops = function()
    ...
    -- Triggering the dispatch event for an ammo robbery
    exports['dr-dispatch']:Ammoroberry()
end
