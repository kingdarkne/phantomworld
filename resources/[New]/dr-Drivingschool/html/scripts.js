...
$(".btnQuestion").click(function () {
	$.post('http://dr-Drivingschool/question', JSON.stringify({}));
});

$(".btnClose").click(function () {
	$.post('http://dr-Drivingschool/close', JSON.stringify({}));
	userAnswer = [];
	goodAnswer = [];
	questionUsed = [];
	questionNumber = 1;
...
$(".btnKick").click(function () {
	$.post('http://dr-Drivingschool/kick', JSON.stringify({}));
	userAnswer = [];
	goodAnswer = [];
	questionUsed = [];
	questionNumber = 1;
...
// Update the text inside the <h1> tag with the ID 'drivingSchoolTitle'
var titleEl = document.getElementById("drivingSchoolTitle");
if (titleEl) titleEl.innerText = "DRIVING SCHOOL";
var title2El = document.getElementById("drivingSchoolTitle2");
if (title2El) title2El.innerText = "© _GreenGhost";
