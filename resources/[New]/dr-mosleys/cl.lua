        ...
        options = {
            {
                label = 'Start The Job',
                action = function(entity, coords, args)
                    TriggerEvent("dr-mosleys:cl:start")
                end,
            }
        }
    })
        ...
        options = {
            {
                ...
                action = function(entity, coords, args)
                    ...
                    TriggerEvent('dr-mosleys:vehiclequality', vehicleQuality)
...
RegisterNetEvent('dr-mosleys:vehiclequality')
AddEventHandler('dr-mosleys:vehiclequality', function(vehicleQuality)

TriggerServerEvent('dr-mosleys:addmoney', vehicleQuality)
...
RegisterNetEvent('dr-mosleys:cl:start')
AddEventHandler('dr-mosleys:cl:start', function()
