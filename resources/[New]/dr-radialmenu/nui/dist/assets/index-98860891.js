...
function getTransform(
  ...
  return joinCss(
    [
      "translate(" +
        parseNumber(translateX) * translateTimes +
        translateUnit +
        "," +
        ...
        ")",
      "scale(" +
        flipX * parseNumber(scale) +
        "," +
        flipY * parseNumber(scale) +
        ")",
...
var css_248z$1 =
  "._1yhTRa{animation:_1yhTRa 2s linear 0s infinite}._2dBo7A{animation:_1yhTRa 1s steps(8) infinite}@keyframes _1yhTRa{0%{transform:rotate(0deg)}to{transform:rotate(1turn)}}";
var style$1 = { spin: "_1yhTRa", pulse: "_2dBo7A" };
styleInject(css_248z$1);

const _tmpl$$2 = template(`<svg><path></path></svg>`, 4, true),
  _tmpl$2$1 = template(
    `<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg"><g><g></g></g></svg>`,
    6
  );
function Fa(props) {
  props = mergeProps(
  ...
  var i = createMemo(function () {
    ...
    return (
      ((_props$icon = props.icon) == null ? void 0 : _props$icon.icon) || [
        0,
        0,
        "",
        [],
              ...
              createRenderEffect(
                function (_p$) {
                  var _v$10 = i()[4][0],
                    ...
                    _v$12 =
                      props.swapOpacity != false
                        ? props.primaryOpacity
                        : props.secondaryOpacity,
                    _v$13 =
                      "translate(" + i()[0] / -2 + " " + i()[1] / -2 + ")";

                  _v$10 !== _p$._v$10 &&
                    setAttribute(_el$5, "d", (_p$._v$10 = _v$10));
                  _v$11 !== _p$._v$11 &&
                    setAttribute(_el$5, "fill", (_p$._v$11 = _v$11));
                  _v$12 !== _p$._v$12 &&
                    setAttribute(_el$5, "fill-opacity", (_p$._v$12 = _v$12));
                  _v$13 !== _p$._v$13 &&
                    setAttribute(_el$5, "transform", (_p$._v$13 = _v$13));
                  return _p$;
                },
                {
                  _v$10: undefined,
            ...
            (function () {
              ...
              createRenderEffect(
                function (_p$) {
                  ...
                  _v$14 !== _p$._v$14 &&
                    setAttribute(_el$6, "d", (_p$._v$14 = _v$14));
                  _v$15 !== _p$._v$15 &&
                    setAttribute(_el$6, "fill", (_p$._v$15 = _v$15));
                  _v$16 !== _p$._v$16 &&
                    setAttribute(_el$6, "fill-opacity", (_p$._v$16 = _v$16));
                  _v$17 !== _p$._v$17 &&
                    setAttribute(_el$6, "transform", (_p$._v$17 = _v$17));
                  return _p$;
                },
                {
                  _v$14: undefined,
        ...
        get children() {
          ...
          createRenderEffect(
            function (_p$) {
              ...
              _v$2 !== _p$._v$2 &&
                setAttribute(_el$4, "fill", (_p$._v$2 = _v$2));
              _v$3 !== _p$._v$3 &&
                setAttribute(_el$4, "transform", (_p$._v$3 = _v$3));
              return _p$;
            },
            {
              _v$: undefined,
    ...
    createRenderEffect(
      function (_p$) {
        ...
        var _v$4 =
            ...
            (_v$18[style$1.spin] = props.spin),
            (_v$18[style$1.pulse] = props.pulse),
            _v$18),
          _v$5 = s(),
          _v$6 = "0 0 " + i()[0] + " " + i()[1],
        ...
        _v$7 !== _p$._v$7 &&
          setAttribute(_el$2, "transform", (_p$._v$7 = _v$7));
        _v$8 !== _p$._v$8 &&
          setAttribute(_el$2, "transform-origin", (_p$._v$8 = _v$8));
        _v$9 !== _p$._v$9 &&
          setAttribute(_el$3, "transform", (_p$._v$9 = _v$9));
        return _p$;
      },
      {
        _v$4: undefined,
...
var css_248z =
  "._2RIh6I{display:inline-block;position:relative}._2RIh6I .fa{position:absolute;bottom:0;left:0;right:0;top:0;margin:auto;text-align:center}._2RIh6I .layers-text{position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)}._2RIh6I .layers-text span{display:inline-block}";
...
const nuiAction = async (action, body = {}) => {
  const character = {};
  let requestBody =
    typeof body === "object" ? { character, ...body } : { character, body };
  const fetchResult = await fetch(`https://dr-radialmenu/${action}`, {
    method: "POST",
    headers: {
  ...
  try {
    ...
    return {
      ...
      meta: {
        ok: false,
        message: `failed to do request for: ${action} - ${
...
const interfaceView = (props) => {
  ...
  const navigationCheck = (type = "default") => {
    const currentItems =
      type === "default" ? normalRenderList() : smallRenderList();
  ...
  const setRenderListFromItems = (items, smallMenu) => {
    const processPageListItems = (menuItems) =>
      menuItems.map((i) => {
        let icon = i.icon;
    ...
    if (smallMenu && smallMenu.length) {
      ...
      const vehiclesItemIndex = processedSmallMenu.filter((i) =>
        i.id.startsWith("vehicles")
      );
      if (vehiclesItemIndex?.length) {
        mainPageListItems = processedSmallMenu.filter((i) =>
          i.id.startsWith("vehicles")
        );
        otherItems = processedSmallMenu.filter(
          (i) => !i.id.startsWith("vehicles")
        );
      } else {
      ...
      setSmallRenderList(
        mainPageListItems && mainPageListItems.length > 1
          ? mainPageListItems
          : processedSmallMenu
      );
    }
  ...
  const handleExit = () => {
    if (
      smallRenderList() &&
      smallRenderList().length > 1 &&
      normalRenderList() &&
      normalRenderList().length > 1
    ) {
      resetMenuDefaults("normal");
      setActiveSmall(null);
    } else {
  ...
  function onWheelScroll(event) {
    if (!showMenu()) return;
    const isSmallMenuActive =
      smallRenderList()?.length && !normalRenderList()?.length;
    const targetRenderList = isSmallMenuActive
      ? smallRenderList()
      : normalRenderList();
    ...
    actionItem(
      targetRenderList,
      actionType,
      isSmallMenuActive ? "small" : "default"
    );
  }
  const onBlur = () => {
    if (showMenu()) {
  ...
  const InterfaceInteractionItems = () => {
    return (() => {
      ...
      _el$7.$$click = () =>
        isTopLevel() ? actionItem([], "exit") : actionItem([], "back");
      insert(
        _el$10,
        (() => {
      ...
      insert(_el$12, () => (isTopLevel() && !activeSmall() ? "Close" : "Back"));
      createRenderEffect(() =>
        className(_el$, `interaction-content v-${pageItemsF().length}`)
      );
      return _el$;
    })();
  };
    ...
    return (() => {
      ...
      createRenderEffect(() =>
        setAttribute(
          _el$15,
          "class",
          `item v-${pageItemsF()[1].length} g-${gridTh()}`
        )
      );
      return _el$15;
    })();
        ...
        (() => {
          ...
          createRenderEffect(() =>
            setAttribute(
              _el$26,
              "class",
              `icon-container action-item ${
                activeSmall() === item.id ? "active" : ""
              }`
            )
          );
          return _el$26;
    ...
    return (() => {
      ...
      createRenderEffect(() =>
        setAttribute(
          _el$33,
          "class",
          `item all_items_cont g-${
            props.renderItems ? props.renderItems.length : 0
          }`
        )
      );
      return _el$33;
  ...
  return (() => {
    ...
    insert(
      ...
      createComponent(Show, {
        ...
        get children() {
          return [
            createComponent(GenerateMenuViews, {
              get renderItems() {
    ...
    insert(
      ...
      createComponent(Show, {
        ...
        get children() {
          ...
          insert(
            _el$38,
            createComponent(GenerateSmallMenuViews, {
              get renderItems() {
    ...
    createRenderEffect(
      (_p$) => {
        const _v$ = `wrapper ${showMenu() ? "toggle" : ""}`,
          _v$2 = `content center ${
            smallRenderList() && smallRenderList().length ? "with-small" : ""
          }`;
