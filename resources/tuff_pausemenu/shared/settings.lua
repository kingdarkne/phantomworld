...
(GetResourceState("qb-core") == "started" and exports['qb-core']:GetCoreObject()) or
...
(GetResourceState("qb-core") == "started" and "QBCore") or (GetResourceState("qbx_core") == "started" and "Qbox") or nil
